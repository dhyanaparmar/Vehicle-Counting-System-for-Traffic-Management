...
min_width_rect=80 #min width reactangle
min_hieght_rect=80 #min width reactangle
...
while True:
    ...
    for (i,c) in enumerate(counterSahpe):
        ...
        cv2.putText(frame1,"Vehicle"+str(counter),(x,y-20),cv2.FONT_HERSHEY_DUPLEX,1,(255,244,0),2)
